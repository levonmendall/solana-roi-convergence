...
async def _web_safe_full_scope_dispatch_worker(
    ...
    """Preserve PR #68's full-scope batching while moving its commit off-loop."""
...
def install_web_liveness_isolation() -> None:
    """Keep PR #68's persistent-disk batch from blocking Render liveness."""

    # raw_receipt_dispatch_repair resolves this module-global worker when the
    # production task starts. Replacing it here changes no queue topology and is
    # intentionally installed after the full-scope dispatcher.
