...
def _status_with_high_volume_affinity(self: DirectSolanaIngestionPlane) -> dict[str, Any]:
    ...
    # Status may be called on a deliberately partial plane during intrinsic guard
    # tests. Diagnostics must never turn missing pre-runtime endpoint state into a
    # runtime error.
    if endpoints:
