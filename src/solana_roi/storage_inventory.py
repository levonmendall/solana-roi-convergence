...
def inventory_storage(root: str | os.PathLike[str] = DEFAULT_ROOT, *, top_n: int = DEFAULT_TOP_N) -> dict[str, Any]:
    ...
    # stack items are (directory path, top-level bucket). The root itself has no bucket.
