...
COMPOSITION_VERSION = "v51-production-composition-root-125-130-v8-native-cutover"
PAPER_ONLY = True
...
def build_production_system() -> ProductionSystem:
    ...
    # Repair 126 deliberately does not activate legacy class/function installers here.
