...
def _public_status() -> dict[str, Any]:
    return {
        ...
        "high_volume_standby_checkpoint_architecture_installed_before_api_capture": True,
        "healthy_high_volume_websocket_history_replay_removed": True,
        "wallet_forward_pipeline_architecture_installed_before_api_capture": True,
        "historical_wallet_screen_has_promotion_authority": False,
        "realtime_wallet_forward_evidence_required_for_v4": True,
